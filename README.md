...
**Multi Agent Blackboard Bus** is an advanced analytical and computational platform implementing Hearsay-II asynchronous publish-subscribe shared memory bus for multi-agent swarms.
...
docker run -p 8000:8000 multi-agent-blackboard-bus
```
